...
class TDWVerifyCodeNumView: UIView {
    ...
    /// 光标颜色
    var cursorColor = UIColor.HWColorWithHexString(hex: "#0xfab700")
    ...
    fileprivate lazy var lineView: UIView = {
        let line = UIView()
        line.backgroundColor = UIColor.HWColorWithHexString(hex: "#0xe6e6e6")
...
extension TDWVerifyCodeNumView {
    ...
    func setBottomLineFocus(isFocus: Bool) {
        if isFocus {
            lineView.backgroundColor = UIColor.HWColorWithHexString(hex: "#0x999999")
        } else {
            lineView.backgroundColor = UIColor.HWColorWithHexString(hex: "#0xe6e6e6")
        }
    }
